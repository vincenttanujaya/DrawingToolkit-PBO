...
public class DrawingFrame extends JFrame
{
    ...
    private JButton jbLine, jbCircle;
    private JPanel toolboxPanel;
    private JPanel toolboxPadding;
    ...
    public DrawingFrame()
    {
        ...
        toolboxPanel.setLayout( new GridLayout( 1, 1, 1, 1 ) ); //sets padding between widgets in gridlayout
        
        toolboxPadding = new JPanel();
        toolboxPadding.setLayout(new FlowLayout(FlowLayout.LEADING, 1, 1)); //sets padding around the edges
